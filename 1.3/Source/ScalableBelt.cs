...
namespace Rakkle
{
    ...
    public static class ScalableBeltPatch
    {
        ...
        {
            Harmony harmonyInstance = new Harmony("com.Rakkle.rimworld.mod");
        ...
        {
            if (bodyType == RakkleBodyTypeDefOf.RakkleF || bodyType == RakkleBodyTypeDefOf.RakkleM)
            {
                __result = scale;
                return false;
            }
    ...
    [DefOf]
    public static class RakkleBodyTypeDefOf
    {
        public static BodyTypeDef RakkleF;
        public static BodyTypeDef RakkleM;
